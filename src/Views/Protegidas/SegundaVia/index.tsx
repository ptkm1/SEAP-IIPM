          ...
          <form onSubmit={SubmeterDados}>
            <Form>
              ...
              <BlocoInputGrande>
                ...
                <select
                  ...
                  id="isenção"
                  ref={Isençao}
                  onChange={(e) => setIsençao(e.target.value)}
                  defaultValue={dados.Isençao}
                  required
                >
              ...
              <div style={{ display: "flex" }}>
                <BlocoInputGrande>
                  ...
                  <input
                    ...
                    id="usuario"
                    ref={Usuario}
                    value={usuarioParseado.nome.split(" ")[0]}
                    required
                  />
                </BlocoInputGrande>
                <BlocoInputGrande>
              ...
              <BlocoInputGrande>
                ...
                <input
                  ...
                  id="nome_completo"
                  ref={NomeCompleto}
                  defaultValue={dados.NomeCompleto}
                  required
                />
              </BlocoInputGrande>
              <BlocoInputGrande>
              ...
              <BlocoInputGrande>
                ...
                <select
                  ...
                  ref={Profissao}
                  style={{ width: "100%" }}
                  defaultValue={dados.Profissao}
                  required
                >
                  <option className="noprint" value="n/a">
                    n/a
                  </option>
                  {profissoes.map((e: any, i: any) => (
                    <option key={i} value={e.profissao}>
                      {e.profissao}
                    </option>
                  ))}
                </select>
              ...
              <Form2L>
                ...
                <BlocoInputGrande>
                  ...
                  <input
                    type="text"
                    id="distrito"
                    className="id_estadomora1"
                    ref={Distrito}
                    defaultValue={dados.Distrito}
                    required
                  />
                </BlocoInputGrande>
              ...
              <Form2R>
                ...
                <BlocoInputGrande>
                  ...
                  <input
                    ...
                    id="data_registro"
                    ref={DataRegistro}
                    defaultValue={dados.DataRegistro}
                    required
                  />
                </BlocoInputGrande>
              </Form2R>
              ...
              <Form2L>
                <BlocoInputGrande>
                  ...
                  <input
                    ...
                    id="data_certidao"
                    ref={DataCertidao}
                    defaultValue={dados.DataCertidao}
                    required
                  />
                </BlocoInputGrande>
            ...
            <Form2>
              ...
              <Form2X>
                ...
                <BlocoInputGrande>
                  ...
                  <select
                    ...
                    defaultValue={dados.EstadoReside}
                  ...
                  >
                    <option value=""></option>
                    <option value={dados.EstadoReside}>
                      {dados.EstadoReside}
                    </option>
                ...
                <BlocoInputGrande>
                  ...
                  <select
                    ...
                    defaultValue={dados.CidadeReside}
                    onClick={() => BuscarCidadeN()}
                    required
                  >
                    <option value=""></option>
                    <option value={dados.CidadeReside}>
                      {dados.CidadeReside}
                    </option>
              ...
              >
                ...
                <BotãoPreto onClick={SubmeterDados}> Enviar </BotãoPreto>
                {modal ? (
                  <Camera />
                ) : (
              ...
              >
                ...
                <BlocoInputGrande>
                  ...
                  <input
                    ...
                    id="numeroFicha"
                    ref={NumeroDaFicha}
                    defaultValue={dados.NumeroDaFicha}
                    required
                  />
                </BlocoInputGrande>
                ...
                <div id="hiddenInputs">
                  ...
                  <input
                    type="text"
                    id="nomecompleto"
                    value={NomeCompleto.current?.value}
                  />
